...
echo "Creating project with title \"[ODF $VERSION] UI Localization - Sprint $SPRINT/Branch $BRANCH\""

PROJECT_INFO=$(memsource project create --name "[ODF $VERSION] UI Localization - Sprint $SPRINT/Branch $BRANCH" --template-id 193065 -f json)
