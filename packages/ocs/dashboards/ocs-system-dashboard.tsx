...
import { DetailsCard as NFSDetailsCard } from './network-file-system/details-card/details-card';
...
const NFSDashboard: React.FC = () => {
  ...
  const leftCards: React.ComponentType[] = [NFSDetailsCard];
  return (
    <CommonDashboardRenderer leftCards={leftCards} mainCards={mainCards} />
  );
};
