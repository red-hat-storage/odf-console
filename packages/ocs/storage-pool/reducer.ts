...
export type DataProtectionPolicyType = DataProtectionPolicy;

export type ErasureCodingSchemeState = { k: number; m: number } | null;
...
export type StoragePoolState = {
  ...
  erasureCodingScheme: ErasureCodingSchemeState;
};
...
export enum StoragePoolActionType {
  ...
  SET_ERASURE_CODING_SCHEME = 'SET_ERASURE_CODING_SCHEME',
}
...
export type StoragePoolAction =
  ...
  | {
      ...
      payload: ErasureCodingSchemeState;
    };
  ...
  switch (action.type) {
    ...
    case StoragePoolActionType.SET_DATA_PROTECTION_POLICY: {
      return {
        ...
        ...(action.payload === DataProtectionPolicy.Replication && {
          erasureCodingScheme: null,
        }),
      };
    }
    case StoragePoolActionType.SET_ERASURE_CODING_SCHEME: {
      return {
        ...state,
        erasureCodingScheme: action.payload,
      };
    }
    default:
      return state;
