...
import {
  createEncryptionCertificatePayload,
  createEncryptionConfigPayload,
  createEncryptionSecretPayload,
} from '@odf/core/components/scale-encryption/payload';
import { useEncryptionFormValidation } from '@odf/core/components/scale-encryption/useEncryptionFormValidation';
...
const EncryptionConfigModal: React.FC<EncryptionConfigModalProps> = ({
  ...
  const enableEncryption = React.useCallback(async () => {
    ...
    try {
      ...
      await createEncryptionSecretPayload(
      ...
      if (certificate) {
        await createEncryptionCertificatePayload(
