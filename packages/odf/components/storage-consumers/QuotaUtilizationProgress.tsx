...
export const StorageQuotaUtilizationProgress: React.FC<
  StorageQuotaUtilizationProps
> = ({ storageQuota, quotaUtilizationRatio }) => {
  ...
  const isValid = _.isNumber(storageQuota) && _.isNumber(quotaUtilizationRatio);
  return isValid ? (
    <Progress
      value={usedAmount}
