import { NamespacePolicyType, TimeUnits } from '../../constants';
import {
  BackingStoreKind,
  BucketClassType,
  NamespaceStoreKind,
...
export type State = {
  ...
  archiveNamespaceStore: NamespaceStoreKind | null;
};
...
export type Action =
  ...
  | { type: 'setArchiveNamespaceStore'; value: NamespaceStoreKind | null };
