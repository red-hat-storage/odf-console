...
const ReviewPage: React.FC<ReviewPageProps> = ({ state }) => {
  ...
  // Namespace BucketClass: Placement Policy section
  ...
  // Namespace BucketClass: Resources section
  ...
  // Standard BucketClass: Placement Policy section
  ...
  // Standard BucketClass: Resources section
