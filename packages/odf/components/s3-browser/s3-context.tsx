...
import { isClientPlugin, isNotFoundError } from '@odf/shared/utils';
...
import { getObjectStorageNotReadyAlert } from '../s3-common/utils';
...
export const S3Provider: React.FC<S3ProviderProps> = ({
  ...
  if (
    ...
    secretRef?.name === providerConfig?.adminSecretName
  ) {
