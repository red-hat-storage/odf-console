...
const IAM = () => {
  ...
  React.useMemo(() => {
    (async () => {
      setHasNoUsers((await listUsers(config)).length === 0); //set null to see loading page
    })();
  }, [config, hasNoUsers]);
        ...
        <>
          <div className="pf-v5-u-pt-xl pf-v5-u-pb-xl pf-v5-u-pl-lg">
            ...
            <p className="pf-v5-u-pt-md pf-v5-u-disabled-color-100">
              User is an identity who has specific permissions and policies
          ...
          <EmptyState variant={EmptyStateVariant.lg}>
            ...
            <EmptyStateFooter>
              ...
              <EmptyStateActions>
                <Button variant="link">Learn more about IAM</Button>
              </EmptyStateActions>
            </EmptyStateFooter>
          </EmptyState>

          {
            //Update AccessKey is temporarily placed here for testing purpouse
            <UpdateAccessKey
              name="name"
