...
export const getOCSRequestData = ({
  ...
  if (!isMCG && useErasureCoding && erasureCodingSchema) {
    ...
    const cephfsEcDataPoolPostfix = ERASURE_CODING_CEPHFS_DATA_POOL_POSTFIX;
    requestData.spec.managedResources = {
      ...
      cephFilesystems: {
        ...
        defaultStorageClassDataPoolName: cephfsEcDataPoolPostfix,
        additionalDataPools: [
          {
            name: cephfsEcDataPoolPostfix,
            erasureCoded,
          },
        ],
      },
