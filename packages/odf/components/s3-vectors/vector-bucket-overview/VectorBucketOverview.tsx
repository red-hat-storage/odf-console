...
import { VectorBucketDetails } from '../vector-bucket-details/VectorBucketDetails';
import VectorIndexListPage from '../vector-index-list-page/VectorIndexListPage';
    ...
    () => [
      {
        ...
        component: VectorIndexListPage,
      },
      {
        href: 'properties',
        title: t('Properties'),
        component: VectorBucketDetails,
      },
      {
        href: 'permissions',
        title: t('Permissions'),
  ...
  const breadcrumbs = React.useMemo(
    () => [
      ...
      },
      {
        ...
        path: `${getVectorBucketOverviewBaseRoute(vectorBucketName, providerType)}`,
      },
    ],
...
const VectorBucketOverviewContent: React.FC<BucketOverviewContentProps> = ({
  ...
  const customData = React.useMemo(
    ...
    [fresh, s3VectorsClient, triggerRefresh, vectorBucketName]
  );
  ...
  return (
    <>
      <PageHeading
        breadcrumbs={breadcrumbs}
        title={<PageTitle bucketName={vectorBucketName} isVectorBucket />}
        actions={actions(s3VectorsClient)}
        className="pf-v5-u-mt-md"
      />
      <Tabs id="s3-vectors-overview" tabs={navPages} customData={customData} />
    </>
  );
};
