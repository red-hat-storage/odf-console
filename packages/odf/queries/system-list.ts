...
export enum GPFSQueries {
  LATENCY = 'GPFS_LAT',
  IOPS = 'GPFS_IOPS',
  THROUGHPUT = 'GPFS_THROUGHPUT',
  RAW_CAPACITY = 'GPFS_RAW_CAP',
  USED_CAPACITY = 'GPFS_USED_CAP',
}

// Note: GPFS metrics may have multiple pod instances (HA replicas) reporting the same data.
