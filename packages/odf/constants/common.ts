...
export const requestedCapacityTooltip = (t: TFunction) =>
    t(
        'The amount of capacity that would be dynamically allocated on the selected StorageClass.',
    );

export const storageClassTooltip = (t: TFunction) =>
    t(
        'The StorageClass used by OpenShift Data Foundation to write its data and metadata.',
    );
