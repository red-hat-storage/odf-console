...
import { ClientType } from '../components/s3-common/types';
import {
  getAcountBadge,
  getAccountActionsItems,
} from '../components/s3-common/utils';
import { S3VectorsContext } from '../components/s3-vectors/s3-vectors-context';
import { VectorBucketsListTable } from '../components/s3-vectors/vector-buckets-list-page/VectorBucketsListTable';
import { VectorBucketsPagination } from '../components/s3-vectors/vector-buckets-list-page/VectorBucketsPagination';

type VectorBucketInfo = [K8sResourceCommon[], boolean, any];
...
const VectorBucketsListPage: React.FC = () => {
  return <VectorBucketsListPageContent />;
};
