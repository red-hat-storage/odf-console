...
export const AdvancedVaultModal = withHandlePromise(
          ...
          <ModalBody>
            ...
            {kms.authMethod === VaultAuthMethods.TOKEN && (
              <FormGroup
                ...
                className="ceph-advanced-kms__form-body"
                labelIcon={
                  <FieldLevelHelp>{vaultNamespaceTooltip}</FieldLevelHelp>
                }
                helperText={t(
            ...
            <FormGroup
              ...
              className="ceph-advanced-kms__form-body"
              labelIcon={
                <FieldLevelHelp>{vaultClientCertTooltip}</FieldLevelHelp>
              }
            >
              <FileUpload
                id="kms-service-cert"
            ...
            <FormGroup
              ...
              className="ceph-advanced-kms__form-body"
              labelIcon={
                <FieldLevelHelp>{vaultClientKeyTooltip}</FieldLevelHelp>
              }
            >
              <FileUpload
                id="kms-service-key"
