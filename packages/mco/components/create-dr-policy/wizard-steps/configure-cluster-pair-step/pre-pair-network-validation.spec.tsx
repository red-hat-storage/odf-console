...
describe('PrePairNetworkValidation Globalnet section', () => {
  it('reports Globalnet as not required when CIDRs do not overlap', () => {
    renderValidation(
      validationState({ globalnetStatus: GlobalnetStatus.Disabled })
    );
  ...
  it('shows Enabled when Globalnet is on', () => {
    renderValidation(
      validationState({ globalnetStatus: GlobalnetStatus.Enabled })
    );
