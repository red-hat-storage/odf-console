...
import { DRPolicyModel, getName, MirrorPeerModel } from '@odf/shared';
...
import CommonStorageClassDropdown from './storage-class-selection/common-storageclass-dropdown';
              ...
              {state.isClusterSelectionValid && (
                <>
                  ...
                  {state.replicationBackend ===
                    ...
                    <>
                      <ThirdPartyStorageWarning docHref="www.redhat.com" />
                      <FormGroup
                        fieldId="common-storage-class"
                        label={t('Common storage class')}
                      >
                        <CommonStorageClassDropdown
                          selectedClusters={clusterNames}
                          onSelect={(entry) =>
                            dispatch({
                              type: DRPolicyActionType.SET_COMMON_STORAGE_CLASS,
                              payload: entry,
                            })
                          }
                        />
