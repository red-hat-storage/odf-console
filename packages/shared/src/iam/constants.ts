...
export const USERS_CREATE_PAGE_PATH = '/odf/object-storage/create-iam-user';
...
export const ODF_S3_IAM_PROXY_PATH = `${ODF_PROXY_ROOT_PATH}/s3-iam`;
export const S3_IAM_INTERNAL_ENDPOINT_PREFIX = 'https://s3-iam.';
