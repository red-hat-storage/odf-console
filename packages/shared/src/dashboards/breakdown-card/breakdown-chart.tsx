...
// Label padding/margin tokens (10/8) match master legend sizes; FontSize_xs is 12 and too large.
...
// Same values as before (and master): barWidth 12, spacer 7, bottom pad 35, plot 25, y 40, height 60.
const stackBarWidth = Number(chartBarWidth.value) + legendTitlePadding;
const symbolSpacer = legendLabelPadding - 2 * legendTitlePadding + 1;
const chartBottomPadding =
  legendMargin + legendLabelPadding + legendCapacityFontSize + 1;
const plotHeight = legendMargin + stackBarWidth - 2 * legendTitlePadding + 1;
